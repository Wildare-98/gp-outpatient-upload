...
### Added
- **自动更新**：软件支持自动更新，无需手动下载新版本

## [v1.7] — 2026-09-17

### Added
- **手写病历免图片上传**：手写门诊病历、手写大病历支持不上传图片，直接提交
- **备注支持**：手写门诊病历、手写大病历支持填写备注
...
### Changed
- **skill工作流**：完善了skill工作流，之前工作流缺失


## [v1.4] — 2026-06-24

### Changed
- **登录适配**：为ai优化了登录适配，现在ai会自行检测是否需要登录
- **新 License 服务地址**：License 验证服务迁移至内地地址
